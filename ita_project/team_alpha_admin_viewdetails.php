    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a href="team_alpha_admin_viewfaculty.php">Faculty</a>
                </li>
                <li><a href="team_alpha_admin_viewstudents.php">Students</a>
                </li>
                <li><a href="team_alpha_admin_viewcourses.php">Courses</a>
                </li>				
