...
<body>
	...
	<div id="content">
        ...
        <h2>Add Semester</h2>
		<p>The option will increase the semesters of all the student in the database</p>
		<p>Please ensure to use the option only after the end of the semester</p>
		<input type='button' value='Increase Semester' />
		</form>
	</div>
