    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
				...
				<li><a href="team_alpha_grades_reg_stu.php?course=<?php print($_GET['course']);?>">Registration</a>
                </li>
				<li><a href="team_alpha_grades_mks_stu.php?course=<?php print($_GET['course']);?>">Marks</a>
                </li>
