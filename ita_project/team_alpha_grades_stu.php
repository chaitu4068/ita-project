...
<body>
	...
	<div id="content">
        ...
        <?php
		 ...
		 $query = "select roll_number from student where uname = '" .  $username . "'";
		 ...
		 if(!($result = mysqli_query($connect,$query)))
		  ...
		  $query = "select course_code from reg_students where roll_number = '" .  $stuid . "' and status = 'approved'";
          ...
          {		
		   foreach($row as $key => $value)
		    {
			 print("<h2 ><a href=\"team_alpha_specgrade_stu.php?course=$value\">$value</a></h2>");
