	...
	<div id="content">
		...
		<?php
		   if(!($connect = mysqli_connect("localhost","root","","ita_project")))
			...
			{
			$query = "select * from faculty where uname = '" . $_POST["username"] . "'";
			if(!($result = mysqli_query($connect,$query)))
				{
			...
			if(!empty($_POST["name"]))
			{
			$query = "select * from faculty where name = '" . $_POST["name"] . "'";
			if(!($result = mysqli_query($connect,$query)))
				{
					header("Location:team_alpha_admin_view_induvidual.php");
				}
			...
			{
			$query = "select * from student where rollnumber = '" . $_POST["fac_id"] . "'";
			if(!($result = mysqli_query($connect,$query)))
				{
					header("Location:team_alpha_admin_view_induvidual.php");
				}
