...
<body>
	...
	<div id="content">
		...
		window.onload = getWeights();
		function getWeights()
		{
		 alert("Here");
		var opts = document.getElementById('numWeights').options;
		print '<form name="weights">';
			print '<table>';
			print '<tr>';
			print '<th>Type</th>';
			print '<th>Total</th>';
		...
		for(var i = 0, i < opts; i++)
			{
			print '<tr>';
			print '<td><input type="text" name="comp$i" /></td>';
			print '<td><input type="text" name="total$i" /></td>';
			print '<td><input type="text" name="weightage$i" /></td>';			
			print '</tr>';
			}
			print '</table>';
		...
		<p><a href = "viewExistingPlan.php?course=<?php print($_GET['course']);?>" target = "_blank">View Existing Plan</a></p>
		</form>
	</div>
