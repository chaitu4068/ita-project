...
<body>
	...
	<div id="content">
	<form method="POST" action="team_alpha_admin_view_induvidual_course_2.php">
	<h2>Course Search</h2>
	Course Code: <input type="text" name="Course_id" />
	<input type="submit" value="Submit" />
		...
		<?php 
            ...
            {		
		      ...
		      {
			    print ("<td><input type = \"text\" size = \"15\" value = \"$value\" readonly/></td>");
			  }
