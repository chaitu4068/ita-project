    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a href="team_alpha_admin_users.php?status=<?php print(' ');?>">Add/Delete Users</a>
                </li>
				<li><a href="team_alpha_admin_courses.php">Courses</a>
                </li>
				<li><a href="team_alpha_admin_acct.php">Account</a>
                </li>
				<li><a href="team_alpha_admin_viewdetails.php">View Details</a>
                </li>
