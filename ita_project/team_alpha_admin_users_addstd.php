...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a href="team_alpha_admin_users_addfac.php">Add Faculty</a>
                </li>
	...
	<div id="content">
		<!--Content-->
		<h2>Add Student To Database</h2> <hr />
		...
		<p>Roll No: <input type='text' name='rollnumber' /> </p>
		<p>Semester: <input type='text' name='semester' /> </p>
		<p>Graduation Year: <input type='text' name='batch' /> </p>
